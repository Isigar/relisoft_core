...
ESX.RegisterServerCallback('rcore:getStoredMoney', function(source, cb, datastore)
    getDatastore(datastore, function(store)
...
ESX.RegisterServerCallback('rcore:putStoredMoney', function(source, cb, datastore, type, amount)
    local xPlayer = ESX.GetPlayerFromId(source)
    getDatastore(datastore, function(store)
        local money = store.get('money') or {}
...
ESX.RegisterServerCallback('rcore:takeStoredMoney', function(source, cb, datastore, type, amount)
    local xPlayer = ESX.GetPlayerFromId(source)
    getDatastore(datastore, function(store)
        local money = store.get('money') or {}
        if type == "black_money" then
